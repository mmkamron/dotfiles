...
static char normbordercolor[] = "#4B0082";
static char normfgcolor[] = "#bbbbbb";
static char selfgcolor[] = "#eeeeee";
static char selbordercolor[] = "#4B0082";
...
const char *spcmd1[] = {TERMINAL, "-n", "spterm", "-g", "50x50", NULL};
...
static const Rule rules[] = {
    ...
    {"mpv", "gl", NULL, 1 << 1, 0, -1}, {"Zathura", NULL, NULL, 1 << 2, 0, -1},
...
static const Layout layouts[] = {
    ...
    {"TTT", bstack}, /* Default: Master on top, slaves on bottom */
...
static Key keys[] = {
    ...
    /* { MODKEY,		XK_t,		spawn,		SHCMD("chromium")
     * },
     */
    ...
    {MODKEY, XK_v, spawn,
     SHCMD(TERMINAL " -e devour mpv $(xclip -o -selection clipboard)")},
     ...
     * },
     */
    {MODKEY, XK_n, spawn, SHCMD(TERMINAL " -e nvim vimwiki -c VimwikiIndex")},
    ...
    { MODKEY,XK_F5, spawn, SHCMD(TERMINAL "pacmd set-sink-port alsa_output.pci-0000_00_1f.3.analog-stereo analog-output-lineout")},
    { MODKEY,XK_F6, spawn, SHCMD(TERMINAL "pacmd set-sink-port alsa_output.pci-0000_00_1f.3.analog-stereo analog-output-headphones")},
    {MODKEY, XK_F7, spawn, SHCMD("td-toggle")},
    {MODKEY, XK_F8, spawn, SHCMD("boomer")},
    {MODKEY, XK_F9, spawn, SHCMD("dmenumount")},
    {MODKEY, XK_F10, spawn, SHCMD("dmenuumount")},
    {MODKEY, XK_F11, spawn, SHCMD("guvcview")},
